...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	{
		switch (wParam) {
			//Får Rectangelet til å bevege seg til Venstre
		case VK_LEFT:
			if (positionX + 540 != rect.left) {
				positionX -= 10;
			}
			break;
			//Får Rectangelet til å bevege seg til Høgre
		case VK_RIGHT:
	...
	case WM_TIMER:
	{
		...
		//Får ballen til å sprette når du treffer venstre eller høgre side av vinduet
		...
		// Får ballen til å sprette når du treffer bunnen av vindet og resetter scoren
		...
		// Får ballen til å sprette når du treffer Rectangellet og øker scoren
